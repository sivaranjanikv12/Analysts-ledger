...
# ============================================================
# FINANCE DICTIONARY
# ONLY TERMS WITH ACTUAL DATA ARE SHOWN
# ============================================================
...
GLOSSARY = {
    ...
    "Expense Ratio": {
        "term": "Expense Ratio",
        "star": True,
        "definition": "The annual percentage of a fund's assets used to cover its operating expenses.",
        "example": "If a mutual fund has an expense ratio of 1%, approximately ₹1 is charged annually for every ₹100 invested.",
        "formula": "Expense Ratio = Fund Operating Expenses / Average Assets Under Management",
        "worked": "Average AUM = ₹100 crore, Operating Expenses = ₹1 crore → Expense Ratio = 1%",
        "hi": "Higher expense ratio → higher cost to the investor and a larger return drag.",
    ...
    "Alpha": {
        "term": "Alpha",
        "star": True,
        "definition": "Alpha measures the excess return generated by an investment relative to the return expected for its level of risk.",
        "example": "If a portfolio earns 15% while its expected return based on its benchmark risk is 12%, the portfolio has generated approximately 3% alpha.",
        "formula": "Alpha = Actual Return − Expected Return",
        "worked": "Actual return = 15%, Expected return = 12% → Alpha = 3%",
        "hi": "Positive alpha → performance above the expected return.",
        "lo": "Negative alpha → performance below the expected return.",
        "strategy": "Alpha is commonly used to evaluate whether active management has generated excess performance after considering risk.",
        "interview": "Alpha represents excess risk-adjusted return. A positive alpha suggests that a portfolio generated more return than expected for the amount of systematic risk taken."
    },
    ...
    "Accounts Payable": {
        ...
        "example": "A company receives ₹10 lakh of inventory from a supplier and agrees to pay after 30 days. The ₹10 lakh becomes accounts payable.",
        "formula": "Accounts Payable = Amounts owed to suppliers",
        "worked": "Purchases on credit = ₹50 lakh → Accounts Payable increases by ₹50 lakh, before payments.",
        "hi": "Higher payable balance can preserve cash in the short term but may indicate slower supplier payments.",
        "lo": "Lower payable balance may indicate faster payment or lower credit purchases.",
        "strategy": "Analyse accounts payable together with payable days and the cash conversion cycle.",
        "interview": "Accounts payable represents short-term obligations to suppliers. I would analyse it alongside payable days and operating cash flow to understand working-capital management."
    },

    "Accounts Receivable": {
        "term": "Accounts Receivable",
        "star": False,
        "definition": "Money owed to a company by customers for goods or services already sold on credit.",
        "example": "A company sells ₹20 lakh of goods on 30-day credit. Until the customer pays, ₹20 lakh is recorded as accounts receivable.",
        "formula": "Receivables Turnover = Credit Sales / Average Accounts Receivable",
        "worked": "Credit sales = ₹100 crore, Average AR = ₹20 crore → Receivables Turnover = 5x.",
        "hi": "Rising receivables relative to sales can indicate collection problems.",
        "lo": "Lower receivables relative to sales generally indicates stronger collections.",
        "strategy": "Track receivables growth against revenue growth and monitor DSO.",
        "interview": "Accounts receivable represents credit sales that have not yet been collected. I would monitor DSO and compare receivables growth with revenue growth to assess earnings quality."
    },
    ...
    "Amortization": {
        ...
        "example": "A ₹10 crore patent with a 10-year useful life could create ₹1 crore of annual amortization under straight-line amortization.",
        "formula": "Annual Amortization = Cost of Asset / Useful Life",
        "worked": "₹10 crore / 10 years = ₹1 crore annual amortization.",
        "hi": "Higher amortization reduces reported accounting profit.",
        "lo": "Lower amortization creates a smaller accounting expense.",
        "strategy": "Amortization is generally non-cash, so analysts reconcile it when moving from accounting profit to cash flow.",
        "interview": "Amortization spreads the cost of an intangible asset over its useful life. Like depreciation, it reduces accounting profit but is generally a non-cash expense."
    },

    "Capital Expenditure": {
        "term": "Capital Expenditure",
        "star": False,
        "definition": "Spending on long-term assets such as property, plant, equipment or technology that provides benefits over multiple periods.",
        "example": "A company spending ₹100 crore to build a new manufacturing plant is making capital expenditure.",
        "formula": "Free Cash Flow = Operating Cash Flow − Capital Expenditure",
        "worked": "Operating Cash Flow = ₹300 crore and CapEx = ₹100 crore → simplified FCF = ₹200 crore.",
        "hi": "Higher CapEx can reduce current free cash flow but may support future growth.",
        "lo": "Lower CapEx may increase near-term free cash flow but could limit future capacity.",
        "strategy": "Separate maintenance CapEx from growth CapEx when analysing a business.",
        "interview": "Capital expenditure is investment in long-term operating assets. I focus on whether CapEx is maintenance or growth-oriented and how efficiently it converts into future cash flows."
    },

    "Dividend Yield": {
        "term": "Dividend Yield",
        "star": False,
        "definition": "The annual dividend received from a share expressed as a percentage of its current market price.",
        "example": "A stock priced at ₹500 paying ₹20 annual dividend has a dividend yield of 4%.",
        "formula": "Dividend Yield = Annual Dividend per Share / Market Price per Share × 100",
        "worked": "Dividend = ₹20, Price = ₹500 → Dividend Yield = 4%.",
        "hi": "Higher yield can indicate stronger income, but may also reflect a falling share price or an unsustainable dividend.",
        "lo": "Lower yield may indicate lower current income or greater reinvestment of profits.",
        "strategy": "Check payout ratio and free cash flow before interpreting a high dividend yield.",
        "interview": "Dividend yield measures the cash dividend return relative to the current share price. I would never evaluate it alone because a high yield can sometimes reflect a declining stock price."
    },
    ...
    "EBITDA": {
        ...
        "example": "EBITDA is often used to compare operating performance across companies with different financing and depreciation structures.",
        "formula": "EBITDA = EBIT + Depreciation + Amortization",
        "worked": "EBIT = ₹80 crore, D&A = ₹20 crore → EBITDA = ₹100 crore.",
        "hi": "Higher EBITDA generally indicates stronger operating earnings before financing, tax and D&A.",
        "lo": "Lower EBITDA indicates weaker operating earnings.",
        "strategy": "Do not treat EBITDA as cash flow because it ignores CapEx and working-capital requirements.",
        "interview": "EBITDA is a useful operating-profit measure, but it is not cash flow. I would always reconcile it with CapEx, working capital and actual operating cash flow."
    },

    "Enterprise Value": {
        "term": "Enterprise Value",
        "star": True,
        "definition": "A measure of the total operating value of a company available to all capital providers.",
        "example": "Enterprise value is commonly compared with EBITDA to calculate the EV/EBITDA valuation multiple.",
        "formula": "EV = Equity Value + Debt − Cash",
        "worked": "Equity Value = ₹1,000 crore, Debt = ₹300 crore, Cash = ₹100 crore → EV = ₹1,200 crore.",
        "hi": "Higher EV relative to operating earnings can indicate a higher valuation multiple.",
        "lo": "Lower EV relative to operating earnings can indicate a lower valuation multiple.",
        "strategy": "Use EV-based multiples when comparing companies with different capital structures.",
        "interview": "Enterprise value represents the value attributable to all capital providers. I use EV-based multiples such as EV/EBITDA when capital structures differ across comparable companies."
    },

    "Net Present Value": {
        "term": "Net Present Value",
        "star": True,
        "definition": "The present value of future project cash flows minus the initial investment.",
        "example": "A project is generally considered value-creating when its NPV is positive at the appropriate discount rate.",
        "formula": "NPV = Σ [CFt / (1+r)^t] − Initial Investment",
        "worked": "If discounted future cash flows are ₹120 crore and the initial investment is ₹100 crore, NPV = ₹20 crore.",
        "hi": "Positive NPV → project creates value relative to the required return.",
        "lo": "Negative NPV → project does not meet the required return.",
        "strategy": "Use NPV as a primary capital-budgeting measure and test sensitivity to key assumptions.",
        "interview": "NPV measures the value created by a project after discounting future cash flows at the required return. A positive NPV indicates value creation relative to that hurdle."
    },

    "Return on Equity": {
        "term": "Return on Equity",
        "star": True,
        "definition": "Measures the profit generated relative to shareholders' equity.",
        "example": "A company earning ₹20 crore on ₹100 crore of equity has an ROE of 20%.",
        "formula": "ROE = Net Income / Average Shareholders' Equity",
        "worked": "Net Income = ₹20 crore, Equity = ₹100 crore → ROE = 20%.",
        "hi": "Higher ROE can indicate efficient use of shareholder capital, subject to leverage effects.",
        "lo": "Lower ROE can indicate weaker returns on shareholder capital.",
        "strategy": "Use DuPont analysis to understand whether ROE comes from margins, asset efficiency or leverage.",
        "interview": "ROE measures the return generated on shareholders' capital. I would decompose it through DuPont analysis before concluding that a high ROE represents strong operating performance."
    },
    ...
    "Working Capital": {
        ...
        "example": "A company with ₹200 crore of current assets and ₹150 crore of current liabilities has ₹50 crore of working capital.",
        "formula": "Working Capital = Current Assets − Current Liabilities",
        "worked": "₹200 crore − ₹150 crore = ₹50 crore.",
        "hi": "Higher working capital can provide liquidity but may also indicate cash tied up in inventory or receivables.",
        "lo": "Lower working capital can improve cash efficiency but may increase short-term liquidity pressure.",
        "strategy": "Analyse inventory, receivables and payables together rather than looking only at the working-capital number.",
        "interview": "Working capital represents the short-term operating funds tied up in the business. I focus on how efficiently inventory, receivables and payables convert into cash."
    }
}

# ------------------------------------------------------------
# Add all terms that have REAL DATA.
# Nothing without a definition/card can appear in the dropdown.
# ------------------------------------------------------------
...
for course, terms in DATA.items():
    for term in terms:
        DATA_TERMS[term["term"].strip().lower()] = term

for name, term in GLOSSARY.items():
    DATA_TERMS[name.strip().lower()] = term

FINANCE_TERMS = sorted(
    [term["term"] for term in DATA_TERMS.values()],
    key=str.lower
)
...
# -----------------------------
    ...
    st.write(
        "Start typing a finance term. Only terms with available data are shown."
    )
    ...
    selected_term = st.selectbox(
        ...
        FINANCE_TERMS,
        index=None,
        placeholder="Type: Exp, WACC, Sharpe, Beta..."
    )

    if selected_term:

        selected_key = selected_term.strip().lower()

        if selected_key in DATA_TERMS:

            render_term(DATA_TERMS[selected_key])
